...
import { ExportCertificateModal } from "./ExportCertificateModal";
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2.5 w-full md:w-auto">
            <Button
              ...
              className="gap-1.5 text-xs flex-1 md:flex-none font-semibold border-slate-200 dark:border-white/10 hover:bg-slate-50 cursor-pointer"
            >
            ...
            <Button
              ...
              className="gap-1.5 text-xs flex-1 md:flex-none font-bold shadow-xs cursor-pointer"
            >
